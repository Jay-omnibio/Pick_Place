...
REQUIRED_AI_INFERENCE_KEYS = {
    ...
    "preplace_max_steps",
    "preplace_progress_eps",
    "preplace_stall_steps",
    "preplace_timeout_extension_steps",
    "preplace_max_timeout_extensions",
    "preplace_timeout_xy_threshold",
    "preplace_timeout_z_threshold",
    "place_xy_threshold",
    "place_z_threshold",
...
OPTIONAL_AI_INFERENCE_KEYS = {
    ...
    "rxinfer_enabled",
    "rxinfer_process_noise_ee",
    "rxinfer_process_noise_obj",
    "rxinfer_process_noise_target",
    "rxinfer_obs_noise_ee",
...
def load_runtime_sections(
    ...
    controller_cfg_out = {
        ...
        "gripper_size_based_open": bool(controller_cfg["gripper_size_based_open"]),
        "gripper_open_clearance": float(controller_cfg["gripper_open_clearance"]),
        "gripper_open_min_width": float(controller_cfg["gripper_open_min_width"]),
        "gripper_open_unknown_full_open": bool(controller_cfg["gripper_open_unknown_full_open"]),
